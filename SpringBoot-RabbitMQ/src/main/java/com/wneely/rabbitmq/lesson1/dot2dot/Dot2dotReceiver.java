...
import static com.wneely.rabbitmq.lesson1.Constant.DOT2DOT_QUEUENAME;

@Slf4j
@Component("dot2dotReceiver")
public class Dot2dotReceiver {

    @RabbitListener(queues = DOT2DOT_QUEUENAME)
    public void receiverMessage(Object message, Channel channel,@Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) throws IOException {
        log.info("接受到消息，消息队列名称为{}，消息为{}", DOT2DOT_QUEUENAME, message);
        //第一个参数表示消息的唯一标识，
        // 第二个参数控制确认范围：
