...
//
//@Slf4j
//@Component("fanoutWorker2Receiver")
//public class FanoutWorker2Receiver {
//
//    @RabbitListener(queues = FANOUT1_QUEUENAME)
...
//        log.info("接受到消息，消息队列名称为{}，消息为{}，deliveryTag为{}", FANOUT1_QUEUENAME, message, deliveryTag);
//        //第一个参数表示消息的唯一标识，
//        // 第二个参数控制确认范围：
