...
//
//import static com.wneely.rabbitmq.lesson1.Constant.FANOUT2_QUEUENAME;
//
//@Slf4j
//@Component("fanoutWorker3Receiver")
//public class FanoutWorker3Receiver {
//
//    @RabbitListener(queues = FANOUT2_QUEUENAME)
...
//        log.info("接受到消息，消息队列名称为{}，消息为{}，deliveryTag为{}", FANOUT2_QUEUENAME, message, deliveryTag);
//        //第一个参数表示消息的唯一标识，
//        // 第二个参数控制确认范围：
